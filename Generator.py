...
def password_generator():
    ...
    symbol_char = random.sample(
        [i for i in list(string.punctuation) if i not in [",", '"', "'", ")", "(", "]", "[", "}", "{"]], ns)

    T = list(string.ascii_uppercase) + list(string.ascii_lowercase) + list(string.digits) + [i for i in
                                                                                             list(string.punctuation) if
                                                                                             i not in [",", '"', "'",
                                                                                                       ")", "(", "]",
                                                                                                       "[", "}", "{"]]
